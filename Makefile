...
GO_LDFLAGS ?= -X github.com/krtffl/poop/internal/version.Version=$(VERSION) \
			-X github.com/krtffl/poop/internal/version.Branch=$(BRANCH) \
			-X github.com/krtffl/poop/internal/version.Revision=$(REVISION) \
			-X github.com/krtffl/poop/internal/version.Built=$(BUILT) \
			-s \
			-w
